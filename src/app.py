...
(function(){
  var now = Date.now();
  var launchStart = Date.UTC(2026, 4, 1, 7, 1);    // May 1 2026 07:01 UTC = 00:01 PT
  var launchEnd   = Date.UTC(2026, 4, 2, 7, 0);    // May 2 2026 07:00 UTC = 24h window
  var banner = document.getElementById('phBanner');
  var text = document.getElementById('phBannerText');
  if (now < launchStart) {
    text.textContent = 'Launching on Product Hunt Friday May 1.';
